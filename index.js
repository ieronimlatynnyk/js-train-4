...
function compareCharCodeAtAndCodePointAt(string, index) {
  ...
  var charCodeAtResult = string.charCodeAt(index);
  ...
  var codePointAtResult = string.codePointAt(index);
